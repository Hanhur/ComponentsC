...
.L5:
	...
	jne	.L12
.L3:
	.loc 1 12 40 discriminator 2
	movzx	eax, BYTE PTR -2[rbp]
	sal	eax, 3
	.loc 1 12 35 discriminator 2
	mov	edx, DWORD PTR 16[rbp]
	mov	ecx, eax
	sar	edx, cl
	.loc 1 12 11 discriminator 2
	movzx	eax, BYTE PTR -2[rbp]
	.loc 1 12 15 discriminator 2
	cdqe
	mov	BYTE PTR -16[rbp+rax], dl
	.loc 1 8 25 discriminator 2
	movzx	eax, BYTE PTR -2[rbp]
	add	eax, 1
...
.Ldebug_macro0:
	...
	.uleb128 0x2
	.ascii "UTILS_H_ \0"
	.file 3 "c:/mingw/x86_64-w64-mingw32/include/string.h"
	.byte	0x3
	.uleb128 0x4
	.uleb128 0x3
	.byte	0x1
	...
	.file 5 "c:/mingw/x86_64-w64-mingw32/include/_mingw.h"
	.byte	0x3
	.uleb128 0xa
	.uleb128 0x5
	.byte	0x1
	...
	.file 6 "c:/mingw/x86_64-w64-mingw32/include/_mingw_mac.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0x6
	.byte	0x1
	...
	.byte	0x4
	.file 7 "c:/mingw/x86_64-w64-mingw32/include/_mingw_secapi.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x7
	.byte	0x1
	...
	.uleb128 0x116
	.ascii "__nothrow \0"
	.file 8 "c:/mingw/x86_64-w64-mingw32/include/vadefs.h"
	.byte	0x3
	.uleb128 0x11a
	.uleb128 0x8
	.byte	0x1
	...
	.file 9 "c:/mingw/x86_64-w64-mingw32/include/sdks/_mingw_directx.h"
	.byte	0x3
	.uleb128 0x253
	.uleb128 0x9
	.byte	0x1
	...
	.byte	0x4
	.file 10 "c:/mingw/x86_64-w64-mingw32/include/sdks/_mingw_ddk.h"
	.byte	0x3
	.uleb128 0x254
	.uleb128 0xa
	.byte	0x1
	...
	.file 11 "c:/mingw/x86_64-w64-mingw32/include/sec_api/string_s.h"
	.byte	0x3
	.uleb128 0xbe
	.uleb128 0xb
	.byte	0x1
